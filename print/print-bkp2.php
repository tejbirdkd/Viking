                                  ...
                                  <table class="table-style" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td style="display: grid;grid-template-columns: auto auto;gap: 5px;">
                                        <img src="https://www.khyberhotels.com/public/uploads/5953823b7dcb5e8666f1bbe91b572b89.jpg">
                                        <img src="<?php echo $base_url . $maintenance_row['uploaded_image']; ?>"></td>
                                ...
                                <div class="clear"> </div>
                                    ...
                                    <div>
                                      <table class="table-style" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <td style="display: grid;grid-template-columns: auto auto;gap: 2px;">
                                        <img src="https://www.khyberhotels.com/public/uploads/5953823b7dcb5e8666f1bbe91b572b89.jpg">
                                        <img src="https://www.khyberhotels.com/public/uploads/5953823b7dcb5e8666f1bbe91b572b89.jpg">

                                          <img src="<?php echo $base_url . $structurerow['uploaded_image']; ?>">
                              ...
                              if ($structural_result->num_rows > 0) {
                                ...
                                while ($row = $structural_result->fetch_assoc()) {
                                 ...
                                 <p><i class="fa-solid fa-leaf"></i> <?php echo $row['category_description'] ?></p>
                                  ...
                                  <td class="images-tow" style="display: grid;grid-template-columns: auto auto;gap: 5px;">
                                    ...
                                    <?php
                                        ...
                                        if ($structural_result->num_rows > 0) {
                                          ...
                                          while ($row = $structural_result->fetch_assoc()) {
                                            ...
                                            <tr>
                                        <td style="width: 25%;"><p><i class="fa-solid fa-lock-open"></i><?php echo $row['deficiency'] ?></p></td>
                                        ...
                                        <td style="display: grid;grid-template-columns: auto auto;gap: 5px;"><img src="<?php echo $base_url . $row['image'] ?>" width="100%"></td>
