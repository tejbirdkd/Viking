...
<body>
    ...
    <div class="wrapper">
      <div class="species-wrp">
        <div class="row">
        <div class="col-12 printbutton"> <button type="button" onclick="window.print()" class="sf-button next-btn" style="float:right; padding:10px 10px; cursor:pointer;"><i class="fa-solid fa-print"></i> Print Full Form</button></div><br>
<br>
        <div class="col-12 printbutton"><a href="printedit.php?id=<?php echo base64_encode($inspection_data['id']); ?>"> <button class="sf-button next-btn" style="float:right; padding:10px 34px; cursor:pointer;"> Form Edit</button></a></div>
