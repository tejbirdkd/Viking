...
$mainid = isset($_GET['id']) ? $_GET['id'] : null;
                ...
                <?php endif; ?>
                        <div class="table-responsive" style="overflow-x: auto;">
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                <?php
                                $i = 1;
                                $maintenance_sql = "SELECT * FROM tower_inspection WHERE user_id = $mainid AND form_type = 'public'";
                                // echo $maintenance_sql; die;
                                // echo $maintenance_sql; die;
                                                    ...
                                                    while ($rows = $maintenance_result->fetch_assoc()) {
                                                        ?>
                                                            ...
                                                            <a href="../adminprint/print.php?id=<?php echo base64_encode($rows['id']); ?>"><button class="btn btn-primary">View</button></a>
                                                                ...
                                                                <a href="deletedata.php?id=<?php echo base64_encode($rows['id']); ?>" onclick="return confirm('Are you sure you want to delete?')"><button class="btn btn-danger">Delete</button></a>
